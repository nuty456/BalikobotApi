...
public enum Option {
   ...
   * ISO 3166-1 alpha-2 <a href="http://cs.wikipedia.org/wiki/ISO_3166-1">...</a>
   */
  ...
  /**
   * Creates an Option object with the specified label.
   *
  ...
  /**
   * Retrieves the Option value associated with the specified label.
   *
   * @param label the label to search for
   * @return the Option value associated with the label, or null if no matching value is found
   */
